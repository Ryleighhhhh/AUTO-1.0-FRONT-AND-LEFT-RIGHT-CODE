...
@Autonomous (name = "EncoderFL")
public class EncoderFL extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        encoderDrive(DRIVE_SPEED, 11, -11, -11, 11, 1.5);
        //place pixel on marker here

        encoderDrive(DRIVE_SPEED, 10.9, 10.9, -10.9, -10.9, 1.5);

        encoderDrive(DRIVE_SPEED, 8, -8, -8, 8, 1.5);
        //place pixel on board

        encoderDrive(DRIVE_SPEED, 10, 10, 10, 10, 1.5);
        //strafeleft^^^^^
